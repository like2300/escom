# Generated by Django 5.2.3 on 2025-08-06 11:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('ETUDIANT', 'Etudiant'), ('ENSEIGNANT', 'Enseignant')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('utilisateur', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='enseignant_utilisateur', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
